...
public class Hologram {
     ...
     * internal cache; it may take some millis
     *
    ...
    public Hologram(Location loc, List<String> lines) {
        ...
        spawnCache = new ArrayList<>();
        destroyCache = new ArrayList<>();
     ...
     *
     * @param p The player who will see this hologram at the location specified by
